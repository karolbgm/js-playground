...
//2. on the right side of the the paremeter list add an arrow =>
//3. if the function implementarion (stuff inside curly braces) is only one line, you can remove the curly braces
